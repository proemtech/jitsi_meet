...
class JitsiMeetEventStreamHandler private constructor(): EventChannel.StreamHandler, Serializable {
    ...
    override fun onListen(arguments: Any?, eventSink: EventChannel.EventSink?) {
        Log.d(JITSI_MEET_TAG, "JitsiMeetEventStreamHandler.onListen")
        this.eventSink = eventSink
    }

    override fun onCancel(arguments: Any?) {
        Log.d(JITSI_MEET_TAG, "JitsiMeetEventStreamHandler.onCancel")
        eventSink = null
    }

    fun onConferenceWillJoin(data: MutableMap<String, Any>?) {
        Log.d(JITSI_MEET_TAG, "JitsiMeetEventStreamHandler.onConferenceWillJoin")
        data?.put("event", "onConferenceWillJoin")
        eventSink?.success(data)
    }

    fun onConferenceJoined(data: MutableMap<String, Any>?) {
        Log.d(JITSI_MEET_TAG, "JitsiMeetEventStreamHandler.onConferenceJoined")
        data?.put("event", "onConferenceJoined")
        eventSink?.success(data)
    }

    fun onConferenceTerminated(data: MutableMap<String, Any>?) {
        Log.d(JITSI_MEET_TAG, "JitsiMeetEventStreamHandler.onConferenceTerminated")
        data?.put("event", "onConferenceTerminated")
        eventSink?.success(data)
    }

    fun onParticipantLeft(data: MutableMap<String, Any>?) {
        Log.d(JITSI_MEET_TAG, "JitsiMeetEventStreamHandler.onParticipantLeft")
        data?.put("event", "onParticipantLeft")
        eventSink?.success(data)
    }

    fun onPictureInPictureWillEnter() {
        Log.d(JITSI_MEET_TAG, "JitsiMeetEventStreamHandler.onPictureInPictureWillEnter")
    ...
    fun onPictureInPictureTerminated() {
        Log.d(JITSI_MEET_TAG, "JitsiMeetEventStreamHandler.onPictureInPictureTerminated")
        var data : HashMap<String, String>
                = HashMap<String, String> ()
    ...
    fun onWhiteboardClicked(){
        Log.d(JITSI_MEET_TAG, "JitsiMeetEventStreamHandler.onWhiteboardClicked")
        var data : HashMap<String, String>
                = HashMap<String, String> ()
