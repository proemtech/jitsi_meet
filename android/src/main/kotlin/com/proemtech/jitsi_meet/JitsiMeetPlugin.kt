...
public class JitsiMeetPlugin() : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
        Log.d(JITSI_MEET_TAG, "method: ${call.method}")
        Log.d(JITSI_MEET_TAG, "arguments: ${call.arguments}")
    ...
    private fun joinMeeting(call: MethodCall, result: Result) {
        ...
        Log.d(JITSI_MEET_TAG, "Joining Room: $room")
        ...
        Log.d(JITSI_MEET_TAG, "Server URL: $serverURL, $serverURLString")
        ...
        JitsiMeetPluginActivity.setData(classroomLogo, whiteboardUrl)
    }

    private fun closeMeeting(call: MethodCall, result: Result) {
        val intent = Intent(JITSI_MEET_CLOSE)
