...
class JitsiMeet {
  ...
  static List<JitsiMeetListener> _listeners = <JitsiMeetListener>[];
  static Map<String, JitsiMeetListener> _perMeetingListeners = {};
...
//            "Slash and anti-slash characters are forbidden"),
  ...
  static addListener(JitsiMeetListener jitsiMeetingListener) {
  ...
  static removeListener(JitsiMeetListener jitsiMeetingListener) {
