...
```groovy
defaultConfig {
    applicationId "com.proemtech.jitsi_meet_example"
...
[request](https://github.com/ShubhamJuIT/jitsi_meet/issues) with the
following template:
```
New Feature Request
...
## Issues
Open an issue [here](https://github.com/ShubhamJuIT/jitsi_meet/issues). Use
